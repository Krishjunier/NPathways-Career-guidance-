// src/pages/Psychometric/LeadershipPage.tsx
...
export default function LeadershipPage() {
    ...
    useEffect(() => {
        ...
        async function loadQuestions() {
            ...
            setError(null);
            try {
                const q = await apiService.getTestQuestions('leadership');
                setQuestions(q);
    ...
    async function handleSubmit(e?: React.FormEvent) {
        ...
        try {
            ...
            navigate("/assessment-transition", { state: { userId, completedTestId: 'leadership' } });
        } catch (err: any) {
        ...
        <div className="modern-container">
            ...
            <div className="container position-relative z-1" style={{ maxWidth: '900px' }}>
                <div className="text-center mb-5">
                    ...
                    <h1 className="fw-bold mb-2">Leadership Assessment</h1>
                    <p className="subtitle">Evaluate your leadership potential</p>
                </div>
