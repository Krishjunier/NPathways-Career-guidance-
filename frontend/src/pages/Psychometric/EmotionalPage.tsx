// src/pages/Psychometric/EmotionalPage.tsx
import React, { useEffect, useState, useRef } from "react";
import { useNavigate, useLocation } from "react-router-dom";
import { ArrowRight, ArrowLeft, CheckCircle, AlertCircle, Loader2, Heart } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    async function loadQuestions() {
      ...
      try {
        ...
        console.error("EmotionalPage load error:", err);
      ...
      <div className="container position-relative z-1" style={{ maxWidth: '900px' }}>
        ...
        <div className="text-center mb-5">
          ...
          <div className="d-flex align-items-center justify-content-center gap-3 mb-2">
            ...
            <h1 className="fw-bold mb-0">Emotional Assessment</h1>
          </div>
          <p className="subtitle">Evaluate your emotional intelligence</p>
        </div>
            ...
            <div className="glass-card p-4 sticky-bottom mt-4" style={{ bottom: '2rem', zIndex: 100 }}>
              <div className="d-flex justify-content-between align-items-center">
                <button
                  ...
                  onClick={() => navigate("/psychometric/aptitude", { state: { userId } })}
                  disabled={submitting}
                >
