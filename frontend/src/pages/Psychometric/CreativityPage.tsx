// src/pages/Psychometric/CreativityPage.tsx
...
export default function CreativityPage() {
    ...
    useEffect(() => {
        ...
        async function loadQuestions() {
            ...
            setError(null);
            try {
                const q = await apiService.getTestQuestions('creativity');
                setQuestions(q);
    ...
    async function handleSubmit(e?: React.FormEvent) {
        ...
        try {
            ...
            navigate("/assessment-transition", { state: { userId, completedTestId: 'creativity' } });
        } catch (err: any) {
        ...
        <div className="modern-container">
            ...
            <div className="container position-relative z-1" style={{ maxWidth: '900px' }}>
                <div className="text-center mb-5">
                    ...
                    <h1 className="fw-bold mb-2">Creativity & Innovation</h1>
                    <p className="subtitle">Explore your creative problem solving skills</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="d-flex flex-column gap-3 mb-5">
                            {questions.map((q, idx) => {
                                ...
                                return (
                                    <div key={q.id} ref={el => { questionRefs.current[idx] = el; }} className={`glass-card p-4 transition-all ${isCurrent ? 'border-primary' : ''}`} onClick={() => setCurrentQuestionIndex(idx)} style={{ opacity: isCurrent ? 1 : 1 }} >
