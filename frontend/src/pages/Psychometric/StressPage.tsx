// src/pages/Psychometric/StressPage.tsx
...
export default function StressPage() {
    ...
    useEffect(() => {
        ...
        async function loadQuestions() {
            ...
            setError(null);
            try {
                const q = await apiService.getTestQuestions('stress');
                setQuestions(q);
        ...
        <div className="modern-container">
            ...
            <div className="container position-relative z-1" style={{ maxWidth: '900px' }}>
                <div className="text-center mb-5">
                    ...
                    <h1 className="fw-bold mb-2">Stress Management Assessment</h1>
                    <p className="subtitle">Understand how you handle pressure</p>
                </div>
